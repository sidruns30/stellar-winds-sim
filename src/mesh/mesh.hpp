...
private:
  ...
  SrcTermFunc_t StarUpdateFunction_;
  EMFSrcTermFunc_t UserEMFSourceTerm_;
  ...
  void EnrollUserExplicitEMFSourceFunction(EMFSrcTermFunc_t my_func);
  void EnrollUserRadSourceFunction(RadSrcTermFunc_t my_func);
  void EnrollUserStarUpdateFunction(SrcTermFunc_t my_func);
