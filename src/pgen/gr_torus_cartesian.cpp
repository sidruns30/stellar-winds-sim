    ...
    AthenaArray<Real> &dg_dx2, AthenaArray<Real> &dg_dx3)
{
  ...
  //   // // Set x-derivatives of covariant components
  // dg_dx1(I00) = (gp(I00)-gm(I00))/(x1p-x1m);
  // dg_dx1(I01) = (gp(I01)-gm(I01))/(x1p-x1m);
  // dg_dx1(I02) = (gp(I02)-gm(I02))/(x1p-x1m);
  // dg_dx1(I03) = (gp(I03)-gm(I03))/(x1p-x1m);
  // dg_dx1(I11) = (gp(I11)-gm(I11))/(x1p-x1m);
  // dg_dx1(I12) = (gp(I12)-gm(I12))/(x1p-x1m);
  // dg_dx1(I13) = (gp(I13)-gm(I13))/(x1p-x1m);
  // dg_dx1(I22) = (gp(I22)-gm(I22))/(x1p-x1m);
  // dg_dx1(I23) = (gp(I23)-gm(I23))/(x1p-x1m);
  // dg_dx1(I33) = (gp(I33)-gm(I33))/(x1p-x1m);
  ...
  //   // // Set x-derivatives of covariant components
  // dg_dx2(I00) = (gp(I00)-gm(I00))/(x2p-x2m);
  // dg_dx2(I01) = (gp(I01)-gm(I01))/(x2p-x2m);
  // dg_dx2(I02) = (gp(I02)-gm(I02))/(x2p-x2m);
  // dg_dx2(I03) = (gp(I03)-gm(I03))/(x2p-x2m);
  // dg_dx2(I11) = (gp(I11)-gm(I11))/(x2p-x2m);
  // dg_dx2(I12) = (gp(I12)-gm(I12))/(x2p-x2m);
  // dg_dx2(I13) = (gp(I13)-gm(I13))/(x2p-x2m);
  // dg_dx2(I22) = (gp(I22)-gm(I22))/(x2p-x2m);
  // dg_dx2(I23) = (gp(I23)-gm(I23))/(x2p-x2m);
  // dg_dx2(I33) = (gp(I33)-gm(I33))/(x2p-x2m);
  ...
  //   // // Set x-derivatives of covariant components
  // dg_dx3(I00) = (gp(I00)-gm(I00))/(x3p-x3m);
  // dg_dx3(I01) = (gp(I01)-gm(I01))/(x3p-x3m);
  // dg_dx3(I02) = (gp(I02)-gm(I02))/(x3p-x3m);
  // dg_dx3(I03) = (gp(I03)-gm(I03))/(x3p-x3m);
  // dg_dx3(I11) = (gp(I11)-gm(I11))/(x3p-x3m);
  // dg_dx3(I12) = (gp(I12)-gm(I12))/(x3p-x3m);
  // dg_dx3(I13) = (gp(I13)-gm(I13))/(x3p-x3m);
  // dg_dx3(I22) = (gp(I22)-gm(I22))/(x3p-x3m);
  // dg_dx3(I23) = (gp(I23)-gm(I23))/(x3p-x3m);
  // dg_dx3(I33) = (gp(I33)-gm(I33))/(x3p-x3m);
