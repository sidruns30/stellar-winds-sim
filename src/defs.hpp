...
// problem generator
#define PROBLEM_GENERATOR "torus_bfield"
...
// allocate hydro boundary arrays
#define ALLOCATE_HYDRO_BOUNDARY_ARRAYS 0

// allocate field boundary arrays
#define ALLOCATE_FIELD_BOUNDARY_ARRAYS 0
