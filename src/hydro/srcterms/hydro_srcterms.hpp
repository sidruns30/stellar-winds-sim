...
public:
  ...
  void AddRadSourceTerms(const Real time, const Real dt,
    const AthenaArray<Real> &p_old, AthenaArray<Real> &p);
  ...
  void EnrollStarUpdateFunction(SrcTermFunc_t my_func);
  void EnrollRadSrcTermFunction(RadSrcTermFunc_t my_Func);
  SrcTermFunc_t UserSourceTerm;
  SrcTermFunc_t StarUpdateFunction;
  RadSrcTermFunc_t UserRadSourceTerm;
